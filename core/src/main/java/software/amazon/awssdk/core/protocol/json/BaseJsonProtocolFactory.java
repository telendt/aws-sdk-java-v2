...
public abstract class BaseJsonProtocolFactory {
     ...
     */
    public abstract <T extends SdkResponse> JsonResponseHandler<T> createResponseHandler(JsonOperationMetadata operationMetadata, Unmarshaller<T,
        JsonUnmarshallerContext> responseUnmarshaller);
